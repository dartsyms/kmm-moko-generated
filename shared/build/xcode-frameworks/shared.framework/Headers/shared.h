...
- (SharedErrorModel *)doCopyMessage:(NSString *)message code:(int32_t)code __attribute__((swift_name("doCopy(message:code:)")));
...
- (instancetype)initWithHref:(NSString *)href title:(NSString * _Nullable)title ingredients:(NSString * _Nullable)ingredients thumbnail:(NSString * _Nullable)thumbnail __attribute__((swift_name("init(href:title:ingredients:thumbnail:)"))) __attribute__((objc_designated_initializer));
- (NSString *)component1 __attribute__((swift_name("component1()")));
- (NSString * _Nullable)component2 __attribute__((swift_name("component2()")));
- (NSString * _Nullable)component3 __attribute__((swift_name("component3()")));
- (NSString * _Nullable)component4 __attribute__((swift_name("component4()")));
- (SharedRecipe *)doCopyHref:(NSString *)href title:(NSString * _Nullable)title ingredients:(NSString * _Nullable)ingredients thumbnail:(NSString * _Nullable)thumbnail __attribute__((swift_name("doCopy(href:title:ingredients:thumbnail:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *href __attribute__((swift_name("href")));
@property (readonly) NSString * _Nullable ingredients __attribute__((swift_name("ingredients")));
...
@interface SharedRecipeCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RecipeList")))
@interface SharedRecipeList : SharedBase
- (instancetype)initWithTitle:(NSString * _Nullable)title results:(NSArray<SharedRecipe *> * _Nullable)results __attribute__((swift_name("init(title:results:)"))) __attribute__((objc_designated_initializer));
- (NSString * _Nullable)component1 __attribute__((swift_name("component1()")));
- (NSArray<SharedRecipe *> * _Nullable)component2 __attribute__((swift_name("component2()")));
- (SharedRecipeList *)doCopyTitle:(NSString * _Nullable)title results:(NSArray<SharedRecipe *> * _Nullable)results __attribute__((swift_name("doCopy(title:results:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSArray<SharedRecipe *> * _Nullable results __attribute__((swift_name("results")));
@property (readonly) NSString * _Nullable title __attribute__((swift_name("title")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RecipeList.Companion")))
@interface SharedRecipeListCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
...
@property (class, readonly) id<SharedKotlinCoroutineContext> ioDispatcher __attribute__((swift_name("ioDispatcher")));
@property (class, readonly) id<SharedKotlinCoroutineContext> uiDispatcher __attribute__((swift_name("uiDispatcher")));
@end;
...
__attribute__((swift_name("Kotlinx_serialization_coreJson")))
@interface SharedKotlinx_serialization_coreJson : SharedBase <SharedKotlinx_serialization_coreStringFormat>
- (id _Nullable)decodeFromJsonElementDeserializer:(id<SharedKotlinx_serialization_coreDeserializationStrategy>)deserializer element:(SharedKotlinx_serialization_coreJsonElement *)element __attribute__((swift_name("decodeFromJsonElement(deserializer:element:)")));
- (id _Nullable)decodeFromStringDeserializer:(id<SharedKotlinx_serialization_coreDeserializationStrategy>)deserializer string:(NSString *)string __attribute__((swift_name("decodeFromString(deserializer:string:)")));
- (SharedKotlinx_serialization_coreJsonElement *)encodeToJsonElementSerializer:(id<SharedKotlinx_serialization_coreSerializationStrategy>)serializer value:(id _Nullable)value __attribute__((swift_name("encodeToJsonElement(serializer:value:)")));
- (NSString *)encodeToStringSerializer:(id<SharedKotlinx_serialization_coreSerializationStrategy>)serializer value:(id _Nullable)value __attribute__((swift_name("encodeToString(serializer:value:)")));
- (SharedKotlinx_serialization_coreJsonElement *)parseToJsonElementString:(NSString *)string __attribute__((swift_name("parseToJsonElement(string:)")));
@property (readonly) SharedKotlinx_serialization_coreSerializersModule *serializersModule __attribute__((swift_name("serializersModule")));
@end;
...
- (SharedKotlinNothing * _Nullable)fill __attribute__((swift_name("fill()")));
- (int32_t)fillDestination:(SharedKtor_ioMemory *)destination offset:(int32_t)offset length:(int32_t)length __attribute__((swift_name("fill(destination:offset:length:)")));
- (NSString *)description __attribute__((swift_name("description()")));
@end;
